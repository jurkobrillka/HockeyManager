...
public class HockeyManager {
    ...
    public void AddNewForward(Team team, String name, int age) {
    ...
    public void AddNewDefender(Team team, String name, int age) {
    ...
    public void AddNewGoalie(Team team, String name, int age) {
    ...
    public void PrintNameAndAgeOfTheYoungestPlayer(Team team) {
        team.getPlayers().sort(new Comparator<Player>() {
            @Override
